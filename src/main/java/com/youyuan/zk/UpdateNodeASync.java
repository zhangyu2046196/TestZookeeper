...
public class UpdateNodeASync implements Watcher {
    ...
    public static void main(String[] args) {
        try {
            zooKeeper=new ZooKeeper("172.18.32.16:12181,172.18.32.21:12181,172.18.32.25:12181",5000,new UpdateNodeASync());
            Thread.sleep(Integer.MAX_VALUE);
            System.out.println("客户端与服务端创建连接状态:"+zooKeeper.getState());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void executeService() {
        zooKeeper.setData("/myconfig/username","root".getBytes(),-1,new IStatCallBack(),"异步修改节点信息");
    }
    ...
    class IStatCallBack implements AsyncCallback.StatCallback{
        ...
        public void processResult(int rc, String path, Object ctx, Stat stat) {
            ...
            System.out.println("异步修改节点回调数据:"+stringBuilder.toString());
        }
    }
}
